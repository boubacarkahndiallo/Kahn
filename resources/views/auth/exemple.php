...
$('#register-user').click(function () {
    ...
    if (firstname != "" && /^[a-zA-Z ÀÁÂÃÄÅàáâãäåÒÓÔÕÖØòóôõöĒĔĖĚēėéêëç ÇȊȋÙÚÛÜùúûüÿŇń]+$/.test(firstname)) {
        // console.log("working");
        $('#firstname').removeClass('is-invalid');
        $('#firstname').addClass('is-valid');
        $('#error-register-firstname').text('');
        // alert('working');
        if (lastname != "" && /^[a-zA-Z ÀÁÂÃÄÅàáâãäåÒÓÔÕÖØòóôõöĒĔĖĚēėéêëçÇȊȋÙÚÛÜùúûüÿŇń]+$/.test(lastname)) {
